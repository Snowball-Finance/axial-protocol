...
const masterAbi = [
  {
    inputs: [
      ...
      { internalType: "contract IERC20", name: "_axial", type: "address" },
  ...
  },
  {
    ...
    name: "pendingTokens",
    outputs: [
      { internalType: "uint256", name: "pendingAxial", type: "uint256" },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint256", name: "accAxialPerShare", type: "uint256" },
