...
/**
 * @title SwapMigrator
 * @dev This contract is responsible for migrating old USD pool liquidity to the new ones.
...
contract SwapMigrator {
    ...
    /**
     * @dev Sets the storage variables and approves tokens to be used by the old and new swap contracts
    ...
    /**
     * @dev Migrates old USD pool's LPToken to the new pool
    ...
    /**
     * @dev Rescues any token that may be sent to this contract accidentally.
