 ...
 * @dev A wrapper for an ERC-20 that can be staked and withdrawn.
...
contract StakeableTokenWrapper {
    ...
    /**
     * @dev Creates a new StakeableTokenWrapper with given `_stakedToken` address
    ...
    /**
     * @dev Read how much `account` has staked in this contract
    ...
    /**
     * @dev Stakes given `amount` in this contract
    ...
    /**
     * @dev Withdraws given `amount` from this contract
