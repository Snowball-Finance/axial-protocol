...
/**
 * @title SynthSwapper
 * @dev Replacement of Virtual Synths in favor of gas savings. Allows swapping synths via the Synthetix protocol
...
contract SynthSwapper is Initializable {
    ...
    /**
     * @dev Initializes the contract when deploying this directly. This prevents
    ...
    /**
     * @dev This modifier checks if the caller is the owner
     */
    modifier onlyOwner() {
    ...
    /**
     * @dev Sets the `owner` as the caller of this function
     */
    ...
    /**
     * @dev Swaps the synth to another synth via the Synthetix protocol.
    ...
    /**
     * @dev Approves the given `tokenFrom` and swaps it to another token via the given `swap` pool.
    ...
    /**
     * @dev Withdraws the given amount of `token` to the `recipient`.
    ...
    /**
     * @dev Destroys this contract. Only owner can call this function.
     */
