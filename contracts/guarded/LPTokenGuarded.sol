 ...
 * @dev This token is an ERC20 detailed token with added capability to be minted by the owner.
...
contract LPTokenGuarded is ERC20Burnable, Ownable {
    ...
    /**
     * @dev Deploys LPToken contract with given name, symbol, and decimals
    ...
    /**
     * @dev Mints the given amount of LPToken to the recipient. During the guarded release phase, the total supply
