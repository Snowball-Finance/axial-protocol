...
contract SwapGuarded is OwnerPausable, ReentrancyGuard {
    ...
    /**
     * @dev Deploys this Swap contract with given parameters as default
    ...
    /**
     * @dev Reads and returns the address of the allowlist that is set during deployment of this contract
    ...
    /**
     * @dev Return timestamp of last deposit of given address
    ...
    /**
     * @dev Calculate the fee that is applied when the given user withdraws. The withdraw fee
    ...
    /**
     * @dev Add liquidity to the pool with given amounts during guarded launch phase. Only users
    ...
    /**
     * @dev Updates the user withdraw fee. This function can only be called by
    ...
    /**
     * @dev Update the withdraw fee. This fee decays linearly over 4 weeks since
     * user's last deposit.
    ...
    /**
     * @dev Disables the guarded launch phase, removing any limits on deposit amounts and addresses
     */
    ...
    /**
     * @dev Reads and returns current guarded status of the pool
