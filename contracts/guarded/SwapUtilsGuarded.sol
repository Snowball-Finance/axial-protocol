 ...
 * @dev A library to be used within Swap.sol. Contains functions responsible for custody and AMM functionalities.
...
library SwapUtilsGuarded {
    ...
    /**
     * @dev Return A in its raw precision
     * @dev See the StableSwap paper for details
     * @param self Swap struct to read from
    ...
    /**
     * @dev Calculates and returns A based on the ramp settings
     * @dev See the StableSwap paper for details
     * @param self Swap struct to read from
     * @return A parameter in its raw precision form
     */
    ...
    /**
     * @dev Retrieves the timestamp of last deposit made by the given address
     * @param self Swap struct to read from
    ...
    /**
     * @dev Calculate the dy, the amount of selected token that user receives and
    ...
    /**
     * @dev Calculate the price of a token in the pool with given
    ...
    /**
     * @dev Get D, the StableSwap invariant, based on self Swap struct
     * @param self Swap struct to read from
     * @return The invariant, at the precision of the pool
     */
    ...
    /**
     * @dev Calculate the new balances of the tokens given the indexes of the token
    ...
    /**
     * @dev Externally calculates a swap between two tokens.
     * @param self Swap struct to read from
    ...
    /**
     * @dev Calculate the fee that is applied when the given user withdraws.
    ...
    /**
     * @dev return accumulated amount of admin fees of the token with given index
     * @param self Swap struct to read from
    ...
    /**
     * @dev internal helper function to calculate fee per token multiplier used in
    ...
    /**
     * @dev Update the withdraw fee for `user`. If the user is currently
    ...
    /**
     * @dev Burn LP tokens to remove liquidity from the pool.
    ...
    /**
     * @dev withdraw all admin fees to a given address
    ...
    /**
     * @dev update the default withdraw fee. This also affects deposits made in the past as well.
     * @param self Swap struct to update
    ...
    /**
     * @dev Start ramping up or down A parameter towards given futureA_ and futureTime_
    ...
    /**
     * @dev Stops ramping A immediately. Once this function is called, rampA()
