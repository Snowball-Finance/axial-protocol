...
/**
 * @title Allowlist
 * @dev This contract is a registry holding information about how much each swap contract should
...
contract Allowlist is Ownable, IAllowlist {
    ...
    /**
     * @dev Creates this contract and sets the PoolCap of 0x0 with uint256(0x54dd1e) for
    ...
    /**
     * @dev Returns the max mintable amount of the lp token per account in given pool address.
    ...
    /**
     * @dev Returns the maximum total supply of the pool token for the given pool address.
     * @param poolAddress address of the pool
     */
    ...
    /**
     * @dev Returns true if the given account's existence has been verified against any of the past or
    ...
    /**
     * @dev Checks the existence of keccak256(account) as a node in the merkle tree inferred by the merkle root node
    ...
    /**
     * @dev Sets the account limit of allowed deposit amounts for the given pool
     * @param poolAddress address of the pool
    ...
    /**
     * @dev Sets the max total supply of LPToken for the given pool address
     * @param poolAddress address of the pool
    ...
    /**
     * @dev Updates the merkle root that is stored in this contract. This can only be called by
